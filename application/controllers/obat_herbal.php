...
class Obat_Herbal extends CI_Controller {
	...
	public function index()
	{
		...
		$this->data['body'] = 'obat_herbal/view';
		...
		$record = $this->Obat_Herbal_Model->getAll($limit, $this->data['limitstart']);
		$this->load->library('pagination');
        $config['base_url'] = site_url('obat_herbal/index');
		...
		/*
		$this->data['sort'] = $this->Obat_Herbal_Model->getSort();
		*/
	...
	public function detail($id)
	{
		...
		$this->data['header'] = 'header';
		$this->data['navigation'] = 'navigation';
		$this->data['body'] = 'obat_herbal/detail';
		$this->data['footer'] = 'footer';
		
		$this->data['data'] = $this->Obat_Herbal_Model->getById($id);
