...
class Kursus extends CI_Controller {
	...
	{
        $this->data['center_area'] = 'kursus/view';
		...
		$record = $this->Kursus_Model->getAll($this->data['limit'], $this->data['limitstart']);
        ...
        $config['base_url'] = site_url('kursus/index');
		...
		$this->data['kategori'] = $this->Kursus_Model->getKategori(TRUE, FALSE);
		$this->data['wilayah'] = $this->Kursus_Model->getWilayah(TRUE, FALSE);
		$this->data['sort'] = $this->Kursus_Model->getSort();
	...
	{
		$this->data['center_area'] = 'kursus/detail';
        $this->data['right_column'] = 'right_column_info';
		...
		$this->data['data'] = $this->Kursus_Model->getById($id);
