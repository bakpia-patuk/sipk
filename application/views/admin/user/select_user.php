...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-gb" lang="en-gb" dir="ltr">
	<head>
		...
		<link rel="stylesheet" href="<?php echo base_url(); ?>css/admin/modal.css" type="text/css" />
	...
	<body id="mc-standalone" class="transitions-enabled headers-fancy extendmenu-off menuwidth-small width-variable avatar-1 ltr option-com-users task- view-users">
		<div id="mc-body">
			...
			<div id="mc-component2">
				<form action="<?php echo site_url('admin/admin/select_user'); ?>" method="post" name="adminForm" id="adminForm">
