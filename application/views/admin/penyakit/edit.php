<script type="text/javascript">
    ...
    */
    ...
    window.addEvent('domready', function() {
        new Fx.Accordion(
            $$('div#penyakit-sliders.pane-sliders > .panel > h3.pane-toggler'), 
            $$('div#penyakit-sliders.pane-sliders > .panel > div.pane-slider'), {
                onActive: function(toggler, i) {
                    toggler.addClass('pane-toggler-down');
                    toggler.removeClass('pane-toggler');
                    i.addClass('pane-down');
                    i.removeClass('pane-hide');
                    Cookie.write('jpanesliders_penyakit-sliders', $$('div#penyakit-sliders.pane-sliders > .panel > h3').indexOf(toggler));
                },
                onBackground: function(toggler, i) {
                    ...
                    if ($$('div#penyakit-sliders.pane-sliders > .panel > h3').length == $$('div#penyakit-sliders.pane-sliders > .panel > h3.pane-toggler').length)
                        Cookie.write('jpanesliders_penyakit-sliders',-1);
                },
                duration: 300,
                opacity: false,
                alwaysHide: true
            ...
            Joomla.submitbutton = function(task)
            {
                switch (task) {
                    case 'penyakit.apply':
                        ...
                        jform_task.value = 'penyakit.apply';
                        var jform_form = document.getElementById('penyakit-form');
                        jform_form.action = "<?php echo site_url('admin/penyakit/add?'); ?>";
                        Joomla.submitform(task, document.getElementById('penyakit-form'));
                        break;
                    case 'penyakit.save':
                        var form = document.getElementById('penyakit-form');
                        form.action = "<?php echo site_url('admin/penyakit/add'); ?>";
                        Joomla.submitform(task, document.getElementById('penyakit-form'));
                        break;
                ...
                if (task == 'penyakit.cancel' || document.formvalidator.isValid(document.id('penyakit-form'))) {
                    Joomla.submitform(task, document.getElementById('penyakit-form'));
                }
            }
		</script>
        <?php echo validation_errors(); ?>
		<form action="<?php echo site_url('admin/penyakit'); ?>" method="post" name="adminForm" id="penyakit-form" class="form-validate" enctype="multipart/form-data">
			<div class="width-60 fltlft">
				<fieldset class="adminform">
					...
					<ul class="adminformlist">
						<li>
                            <label id="jform_nama-lbl" for="jform_nama" class="hasTip required" title="">Nama Penyakit<span class="star">&nbsp;*</span></label>
							<input type="hidden" name="jform[id]" id="jform_id" value="<?php echo $data->id; ?>">
                            <input name="jform[nama]" id="jform_nama" class="inputbox required" size="54" maxlength="250" type="text" value="<?php echo htmlentities($data->nama); ?>" autocomplete="off">
                        </li>
                        <li>
                        ...
                        <li>
                            <label id="jform_deskripsi-lbl" for="jform_deskripsi" class="hasTip" title="">Deskripsi Penyakit</label>
                            <div class="clr"></div>
                            <textarea name="jform[deskripsi]" id="jform_deskripsi" cols="0" rows="0" style="width:100%; height:100px;" class="mce_editable"><?php echo $data->deskripsi; ?></textarea>
                        ...
                        <li>
                            <label id="jform_gejala-lbl" for="jform_gejala" class="hasTip" title="">Gejala</label>
                            <div class="clr"></div>
                            <textarea name="jform[gejala]" id="jform_gejala" cols="0" rows="0" style="width:100%; height:100px;" class="mce_editable"><?php echo $data->gejala; ?></textarea>
                            <div id="editor-xtd-buttons"></div>
                            <div class="toggle-editor">
                                <div class="button2-left">
                                    <div class="blank">
                                        <a href="#" onclick="tinyMCE.execCommand('mceToggleEditor', true, 'jform_gejala');return false;" title="Toggle editor">Toggle editor</a>
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li>
                            <label id="jform_pencegahan-lbl" for="jform_pencegahani" class="hasTip" title="">Pencegahan</label>
                            <div class="clr"></div>
                            <textarea name="jform[pencegahan]" id="jform_pencegahan" cols="0" rows="0" style="width:100%; height:100px;" class="mce_editable"><?php echo $data->pencegahan; ?></textarea>
                            <div id="editor-xtd-buttons"></div>
                            <div class="toggle-editor">
                                <div class="button2-left">
                                    <div class="blank">
                                        <a href="#" onclick="tinyMCE.execCommand('mceToggleEditor', true, 'jform_pencegahan');return false;" title="Toggle editor">Toggle editor</a>
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li>
                            <label id="jform_pengobatan-lbl" for="jform_pengobatan" class="hasTip" title="">Pengobatan</label>
                            <div class="clr"></div>
                            <textarea name="jform[pengobatan]" id="jform_pengobatan" cols="0" rows="0" style="width:100%; height:100px;" class="mce_editable"><?php echo $data->pengobatan; ?></textarea>
                            <div id="editor-xtd-buttons"></div>
                            <div class="toggle-editor">
                                <div class="button2-left">
                                    <div class="blank">
                                        <a href="#" onclick="tinyMCE.execCommand('mceToggleEditor', true, 'jform_pengobatan');return false;" title="Toggle editor">Toggle editor</a>
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li>
                            <label id="jform_obat-lbl" for="jform_obat" class="hasTip" title="">Obat-obatan yang dapat digunakan</label>
                            <div class="clr"></div>
                            <textarea name="jform[obat]" id="jform_obat" cols="0" rows="0" style="width:100%; height:100px;" class="mce_editable"><?php echo $data->obat; ?></textarea>
                            <div id="editor-xtd-buttons"></div>
                            <div class="toggle-editor">
                                <div class="button2-left">
                                    <div class="blank">
                                        <a href="#" onclick="tinyMCE.execCommand('mceToggleEditor', true, 'jform_obat');return false;" title="Toggle editor">Toggle editor</a>
                                    </div>
                                </div>
                            </div>
                        </li>
			...
			<div class="width-40 fltrt">
				<div id="penyakit-sliders" class="pane-sliders">
					...
					<div class="panel">
						...
						<div class="pane-slider penyakit">
