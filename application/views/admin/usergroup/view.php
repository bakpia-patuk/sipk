...
<script type="text/javascript">
	Joomla.submitbutton = function(task) {
		if (task != 'usergroup.delete' || confirm('Anda yakin untuk menghapus Group ini? Konfirmasi akan menghapus Group yang dipilih.')) {
...
<div class="mc-wrapper">
	...
	<div id="content-box">
		...
		<div id="mc-component" class="clearfix">
			<form action="<?php echo site_url('admin/usergroup'); ?>" method="post" name="adminForm" id="adminForm">
				...
				<table class="adminlist">
					<thead>
						<tr>
							...
							<th>
								<a href="#" onclick="Joomla.tableOrdering('a.group','desc','');" title="Click to sort by this column">Nama Group<img src="<?php echo base_url('images/admin/sort_asc.png'); ?>" alt=""  /></a>
							</th>
						</tr>
					</thead>
					<tfoot>
					...
					<tbody>
						...
						<td class="nowrap">
                            ...
                            ?>
                                    <a href="<?php echo site_url('admin/usergroup/add?id='.$id); ?>"><?php echo $group; ?></a>
                            <?php
                                }
                            ?>
						</td>
