...
<div class="mc-wrapper">
	...
	<div id="content-box">
		...
		<div id="mc-component" class="clearfix">
			<form action="<?php echo site_url('admin/kursus'); ?>" method="post" name="adminForm" id="adminForm">
					...
					<div class="filter-select fltrt">
						<select name="filter_published" class="inputbox" onchange="this.form.submit()">
							<?php
								...
								$kursus_state = array_merge($first, $kursus_state);
								$kursus_state = array_merge($kursus_state, $last);
						...
						<select name="filter_kategori" class="inputbox" onchange="this.form.submit()">
							<?php
								...
								$kursus_kategori = array_merge($first, $kursus_kategori);
						...
						<select name="filter_wilayah" class="inputbox" onchange="this.form.submit()">
							<?php
								...
								$kursus_wilayah = array_merge($first, $kursus_wilayah);
				...
				<table class="adminlist">
					<thead>
						<tr>
							...
							<th>
								<a href="#" onclick="Joomla.tableOrdering('a.nama','desc','');" title="Click to sort by this column">Nama Bimbel/Kursus/Test<img src="/joomla/media/system/images/sort_asc.png" alt=""  /></a>
							</th>
							<th width="5%">
								<a href="#" onclick="Joomla.tableOrdering('a.state','desc','');" title="Click to sort by this column">Status</a>
							</th>
							<th width="10%">
								<a href="#" onclick="Joomla.tableOrdering('a.ordering','asc','');" title="Click to sort by this column">Wilayah</a>
							</th>
							<th width="25%">
								<a href="#" onclick="Joomla.tableOrdering('access_level','asc','');" title="Click to sort by this column">Alamat</a>
							</th>
							<th width="10%">
								<a href="#" onclick="Joomla.tableOrdering('a.created_by','asc','');" title="Click to sort by this column">Telepon</a>
							</th>
							<th width="5%">
					...
					<tbody>
						...
						<td class="nowrap">
							<a href="<?php echo site_url('admin/kursus/edit/'.$id); ?>"><?php echo $nama; ?></a>
						</td>
						<td class="center">
