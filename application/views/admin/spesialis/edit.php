<script type="text/javascript">
    ...
    */
    ...
    window.addEvent('domready', function() {
        new Fx.Accordion(
            $$('div#spesialis-sliders.pane-sliders > .panel > h3.pane-toggler'), 
            $$('div#spesialis-sliders.pane-sliders > .panel > div.pane-slider'), {
                onActive: function(toggler, i) {
                    toggler.addClass('pane-toggler-down');
                    toggler.removeClass('pane-toggler');
                    i.addClass('pane-down');
                    i.removeClass('pane-hide');
                    Cookie.write('jpanesliders_spesialis-sliders', $$('div#spesialis-sliders.pane-sliders > .panel > h3').indexOf(toggler));
                },
                onBackground: function(toggler, i) {
                    ...
                    if ($$('div#spesialis-sliders.pane-sliders > .panel > h3').length == $$('div#spesialis-sliders.pane-sliders > .panel > h3.pane-toggler').length)
                        Cookie.write('jpanesliders_spesialis-sliders',-1);
                },
                duration: 300,
                opacity: false,
                alwaysHide: true
            ...
            Joomla.submitbutton = function(task)
            {
                switch (task) {
                    case 'spesialis.apply':
                        ...
                        jform_task.value = 'spesialis.apply';
                        var jform_form = document.getElementById('spesialis-form');
                        jform_form.action = "<?php echo site_url('admin/spesialis/add?'); ?>";
                        Joomla.submitform(task, document.getElementById('spesialis-form'));
                        break;
                    case 'spesialis.save':
                        var form = document.getElementById('spesialis-form');
                        form.action = "<?php echo site_url('admin/spesialis/add'); ?>";
                        Joomla.submitform(task, document.getElementById('spesialis-form'));
                        break;
                ...
                if (task == 'spesialis.cancel' || document.formvalidator.isValid(document.id('spesialis-form'))) {
                    Joomla.submitform(task, document.getElementById('spesialis-form'));
                }
            }
		</script>
		<form action="<?php echo site_url('admin/spesialis'); ?>" method="post" name="adminForm" id="spesialis-form" class="form-validate">
			<div class="width-60 fltlft">
				<fieldset class="adminform">
					...
					<ul class="adminformlist">
						<li>
							<label id="jform_spesialis-lbl" for="jform_spesialis" class="hasTip required" title="Spesialis::Nama Spesialis kedokteran">Spesialis<span class="star"> *</span></label>
							<?php
                                $value = set_value('jform[id]', $data->id);
                            ?>
                            <input type="hidden" name="jform[id]" id="jform_id" value="<?php echo $value; ?>">
							<?php
                                $value = set_value('jform[spesialis]', $data->spesialis);
                            ?>
							<input type="text" name="jform[spesialis]" id="jform_spesialis" value="<?php echo $value; ?>" class="inputbox required mc-bigger-field" size="40" maxlength="50" />
							<?php echo form_error('jform[spesialis]'); ?>
						</li>
						<li>
						...
						<li>
							<label id="jform_gelar-lbl" for="jform_gelar" class="hasTip" title="Gelar::Gelar untuk spesialis tersebut">Gelar</label>
							<?php
                                $value = set_value('jform[gelar]', $data->gelar);
                            ?>
							<input type="text" name="jform[gelar]" id="jform_gelar" value="<?php echo $value; ?>" class="inputbox mc-bigger-field" size="40" maxlength="50" />
						</li>
                        <div class="clr"></div>
						<label id="jform_deskripsi-lbl" for="jform_deskripsi" class="hasTip" title="">Deskripsi</label>
						<div class="clr"></div>
						<?php
							$value = set_value('jform[deskripsi]', $data->gelar);
						?>
			...
			<div class="width-40 fltrt">
				<div id="spesialis-sliders" class="pane-sliders">
					...
					<div class="panel">
						...
						<div class="pane-slider spesialis">
