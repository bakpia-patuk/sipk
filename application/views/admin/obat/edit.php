<script type="text/javascript">
    ...
    */
    ...
    window.addEvent('domready', function() {
        new Fx.Accordion(
            $$('div#obat-sliders.pane-sliders > .panel > h3.pane-toggler'), 
            $$('div#obat-sliders.pane-sliders > .panel > div.pane-slider'), {
                onActive: function(toggler, i) {
                    toggler.addClass('pane-toggler-down');
                    toggler.removeClass('pane-toggler');
                    i.addClass('pane-down');
                    i.removeClass('pane-hide');
                    Cookie.write('jpanesliders_obat-sliders', $$('div#obat-sliders.pane-sliders > .panel > h3').indexOf(toggler));
                },
                onBackground: function(toggler, i) {
                    ...
                    if ($$('div#obat-sliders.pane-sliders > .panel > h3').length == $$('div#obat-sliders.pane-sliders > .panel > h3.pane-toggler').length)
                        Cookie.write('jpanesliders_obat-sliders',-1);
                },
                duration: 300,
                opacity: false,
                alwaysHide: true
            ...
            Joomla.submitbutton = function(task)
            {
                switch (task) {
                    case 'obat.apply':
                        ...
                        jform_task.value = 'obat.apply';
                        var jform_form = document.getElementById('obat-form');
                        jform_form.action = "<?php echo site_url('admin/obat/add?'); ?>";
                        Joomla.submitform(task, document.getElementById('obat-form'));
                        break;
                    case 'obat.save':
                        var form = document.getElementById('obat-form');
                        form.action = "<?php echo site_url('admin/obat/add'); ?>";
                        Joomla.submitform(task, document.getElementById('obat-form'));
                        break;
                    case 'obat.save2new':
                        var form = document.getElementById('obat-form');
                ...
                if (task == 'obat.cancel' || document.formvalidator.isValid(document.id('obat-form'))) {
                    Joomla.submitform(task, document.getElementById('obat-form'));
                }
            }
		</script>
		<form action="<?php echo site_url('admin/obat'); ?>" method="post" name="adminForm" id="obat-form" class="form-validate">
			<div class="width-60 fltlft">
				<fieldset class="adminform">
					...
					<ul class="adminformlist">
						<li>
                            <label id="jform_nama-lbl" for="jform_nama" class="hasTip required" title="">Nama Obat<span class="star">&nbsp;*</span></label>
							<?php
                            ...
                            ?>
                            <input name="jform[nama]" id="jform_nama" class="inputbox required" size="54" maxlength="50" type="text" value="<?php echo htmlentities($value); ?>" >
                        ...
                        <li>
                            <label id="jform_deskripsi-lbl" for="jform_deskripsi" class="hasTip" title="">Deskripsi obat</label>
                            <div class="clr"></div>
							<?php
                        ...
                        <li>
							...
							<?php
                                $image = set_value('jform[image]', $data->image);
                            ?>
                            <input name="jform[image]" type="hidden" value="<?php echo $image; ?>" />
							<?php
                                $thumbnail = set_value('jform[thumbnail]', $data->thumbnail);
                            ?>
                            <input name="jform[thumbnail]" type="hidden" value="<?php echo $thumbnail; ?>" />
                        ...
                        <li>
                            <label id="jform_komposisi-lbl" for="jform_komposisi" class="hasTip" title="">Komposisi</label>
                            <div class="clr"></div>
							<?php
                                $value = set_value('jform[komposisi]', $data->komposisi);
                            ?>
                            <textarea name="jform[komposisi]" id="jform_komposisi" cols="0" rows="0" style="width:100%; height:100px;" class="mce_editable"><?php echo $value; ?></textarea>
                            <div id="editor-xtd-buttons"></div>
                            <div class="toggle-editor">
                                <div class="button2-left">
                                    <div class="blank">
                                        <a href="#" onclick="tinyMCE.execCommand('mceToggleEditor', true, 'jform_komposisi');return false;" title="Toggle editor">Toggle editor</a>
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li>
                            <label id="jform_dosis-lbl" for="jform_dosis" class="hasTip" title="">Dosis</label>
                            <div class="clr"></div>
							<?php
                                $value = set_value('jform[dosis]', $data->dosis);
                            ?>
                            <textarea name="jform[dosis]" id="jform_dosis" cols="0" rows="0" style="width:100%; height:100px;" class="mce_editable"><?php echo $value; ?></textarea>
                            <div id="editor-xtd-buttons"></div>
                            <div class="toggle-editor">
                                <div class="button2-left">
                                    <div class="blank">
                                        <a href="#" onclick="tinyMCE.execCommand('mceToggleEditor', true, 'jform_dosis');return false;" title="Toggle editor">Toggle editor</a>
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li>
                            <label id="jform_indikasi-lbl" for="jform_indikasi" class="hasTip" title="">Indikasi</label>
                            <div class="clr"></div>
							<?php
                                $value = set_value('jform[indikasi]', $data->indikasi);
                            ?>
                            <textarea name="jform[indikasi]" id="jform_indikasi" cols="0" rows="0" style="width:100%; height:100px;" class="mce_editable"><?php echo $value; ?></textarea>
                            <div id="editor-xtd-buttons"></div>
                            <div class="toggle-editor">
                                <div class="button2-left">
                                    <div class="blank">
                                        <a href="#" onclick="tinyMCE.execCommand('mceToggleEditor', true, 'jform_indikasi');return false;" title="Toggle editor">Toggle editor</a>
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li>
                            <label id="jform_paket-lbl" for="jform_paket" class="hasTip" title="">Paket</label>
                            <div class="clr"></div>
							<?php
                                $value = set_value('jform[paket]', $data->paket);
                            ?>
                            <textarea name="jform[paket]" id="jform_paket" cols="0" rows="0" style="width:100%; height:100px;" class="mce_editable"><?php echo $value; ?></textarea>
                            <div id="editor-xtd-buttons"></div>
                            <div class="toggle-editor">
                                <div class="button2-left">
                                    <div class="blank">
                                        <a href="#" onclick="tinyMCE.execCommand('mceToggleEditor', true, 'jform_paket');return false;" title="Toggle editor">Toggle editor</a>
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li>
                            <label id="jform_no_registrasi-lbl" for="jform_no_registrasi" class="hasTip" title="">No. Registrasi</label>
							<?php
                                $value = set_value('jform[no_registrasi]', $data->no_registrasi);
                            ?>
                            <input name="jform[no_registrasi]" id="jform_no_registrasi" class="inputbox" size="30" maxlength="30" type="text" value="<?php echo htmlentities($value); ?>" >
                        </li>
                        <li>
                            <label id="jform_produksi-lbl" for="jform_produksi" class="hasTip" title="">Di Produksi oleh</label>
							<?php
                                $value = set_value('jform[produksi]', $data->produksi);
                            ?>
                            <input name="jform[produksi]" id="jform_produksi" class="inputbox" size="50" maxlength="50" type="text" value="<?php echo htmlentities($value); ?>" >
                        </li>
						<li>
			...
			<div class="width-40 fltrt">
				<div id="obat-sliders" class="pane-sliders">
