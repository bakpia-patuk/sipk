<script type="text/javascript">
    ...
    */
    ...
    window.addEvent('domready', function() {
        new Fx.Accordion(
            $$('div#tips-sliders.pane-sliders > .panel > h3.pane-toggler'), 
            $$('div#tips-sliders.pane-sliders > .panel > div.pane-slider'), {
                onActive: function(toggler, i) {
                    toggler.addClass('pane-toggler-down');
                    toggler.removeClass('pane-toggler');
                    i.addClass('pane-down');
                    i.removeClass('pane-hide');
                    Cookie.write('jpanesliders_tips-sliders', $$('div#tips-sliders.pane-sliders > .panel > h3').indexOf(toggler));
                },
                onBackground: function(toggler, i) {
                    ...
                    if ($$('div#tips-sliders.pane-sliders > .panel > h3').length == $$('div#tips-sliders.pane-sliders > .panel > h3.pane-toggler').length)
                        Cookie.write('jpanesliders_tips-sliders',-1);
                },
                duration: 300,
                opacity: false,
                alwaysHide: true
            ...
            Joomla.submitbutton = function(task)
            {
                switch (task) {
                    case 'tips.apply':
                        ...
                        jform_task.value = 'tips.apply';
                        var jform_form = document.getElementById('tips-form');
                        jform_form.action = "<?php echo site_url('admin/tips/add'); ?>";
                        Joomla.submitform(task, document.getElementById('tips-form'));
                        break;
                    case 'tips.save':
                        var form = document.getElementById('tips-form');
                        form.action = "<?php echo site_url('admin/tips/add'); ?>";
                        Joomla.submitform(task, document.getElementById('tips-form'));
                        break;
                    case 'tips.save2new':
                        var form = document.getElementById('tips-form');
                ...
                if (task == 'tips.cancel' || document.formvalidator.isValid(document.id('tips-form'))) {
                    Joomla.submitform(task, document.getElementById('tips-form'));
                }
            }
		</script>
        <?php echo validation_errors(); ?>
		<form action="<?php echo site_url('admin/tips'); ?>" method="post" name="adminForm" id="tips-form" class="form-validate">
			<div class="width-60 fltlft">
				<fieldset class="adminform">
					...
					<ul class="adminformlist">
						<li>
                            <label id="jform_judul-lbl" for="jform_judul" class="hasTip required" title="">Judul Tips<span class="star">&nbsp;*</span></label>
							<input type="hidden" name="jform[id]" id="jform_id" value="<?php echo $data->id; ?>">
                            <input name="jform[judul]" id="jform_judul" class="inputbox required" size="54" maxlength="250" type="text" value="<?php echo htmlentities($data->judul); ?>" >
                        </li>
						<li>
                    ...
                    <label id="jform_menutype-lbl" for="jform_deskripsi" class="hasTip required" title="">Tips<span class="star">&nbsp;*</span></label>
                    <div class="clr"></div>
					...
					<div class="clr"></div>
					<ul></ul>
                    <label id="jform_menudescription-lbl" for="jform_sumber" class="hasTip" title="">Sumber</label>
                    <div class="clr"></div>
			...
			<div class="width-40 fltrt">
				<div id="tips-sliders" class="pane-sliders">
