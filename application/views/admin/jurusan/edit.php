<script type="text/javascript">
    ...
    */
    ...
    window.addEvent('domready', function() {
        new Fx.Accordion(
            $$('div#jurusan-sliders.pane-sliders > .panel > h3.pane-toggler'), 
            $$('div#jurusan-sliders.pane-sliders > .panel > div.pane-slider'), {
                onActive: function(toggler, i) {
                    toggler.addClass('pane-toggler-down');
                    toggler.removeClass('pane-toggler');
                    i.addClass('pane-down');
                    i.removeClass('pane-hide');
                    Cookie.write('jpanesliders_jurusan-sliders', $$('div#jurusan-sliders.pane-sliders > .panel > h3').indexOf(toggler));
                },
                onBackground: function(toggler, i) {
                    ...
                    if ($$('div#jurusan-sliders.pane-sliders > .panel > h3').length == $$('div#jurusan-sliders.pane-sliders > .panel > h3.pane-toggler').length)
                        Cookie.write('jpanesliders_jurusan-sliders',-1);
                },
                duration: 300,
                opacity: false,
                alwaysHide: true
			...
			Joomla.submitbutton = function(task)
            {
                switch (task) {
                    case 'jurusan.apply':
                        ...
                        jform_task.value = 'jurusan.apply';
                        var jform_form = document.getElementById('jurusan-form');
                        jform_form.action = "<?php echo site_url('admin/jurusan/add'); ?>";
                        Joomla.submitform(task, document.getElementById('jurusan-form'));
                        break;
                    case 'jurusan.save':
                        var form = document.getElementById('jurusan-form');
                        form.action = "<?php echo site_url('admin/jurusan/add'); ?>";
                        Joomla.submitform(task, document.getElementById('jurusan-form'));
                        break;
                ...
                if (task == 'jurusan.cancel' || document.formvalidator.isValid(document.id('jurusan-form'))) {
                    Joomla.submitform(task, document.getElementById('jurusan-form'));
                }
            }
		</script>
		<form action="<?php echo site_url('admin/jurusan'); ?>" method="post" name="adminForm" id="jurusan-form" class="form-validate">
			<div class="width-60 fltlft">
				<fieldset class="adminform">
					<legend>
						<?php
							if ($is_new)
								echo "Jurusan Perguruan Tinggi Baru";
							else
								echo "Edit Jurusan Perguruan Tinggi";
						?>
					</legend>
					<ul class="adminformlist">
						<li>
							<label id="jform_jurusan-lbl" for="jform_jurusan" class="hasTip required" title="Jurusan::Nama jurusan">Jurusan<span class="star"> *</span></label>
							<?php
                                $value = set_value('jform[id]', $data->id);
                            ?>
							<input type="hidden" name="jform[id]" id="jform_id" value="<?php echo $value; ?>">
							<?php
                                $value = set_value('jform[jurusan]', $data->jurusan);
                            ?>
							<input type="text" name="jform[jurusan]" id="jform_jurusan" value="<?php echo $value; ?>" class="inputbox required mc-bigger-field" size="30">
							<?php echo form_error('jform[jurusan]'); ?>
						...
						<li>
							...
							<select id="jform_state" name="jform[state]" class="inputbox" size="1">
								<?php
                                    foreach ($jurusan_state AS $key => $val) {
                                        if ($value == $key)
						...
						<li>
                            <label id="jform_deskripsi-lbl" for="jform_deskripsi" class="hasTip" title="Deskripsi::Deskripsi jurusan">Deskripsi</label>
                            <div class="clr"></div>
							<?php
						...
						<li>
							<label id="jform_kemampuan_penunjang-lbl" for="jform_kemampuan_penunjang" class="hasTip" title="Kemampuan Penunjang::Kemampuan penunjang">Kemampuan Penunjang</label>
							<div class="clr"></div>
							<?php
                                $value = set_value('jform[kemampuan_penunjang]', $data->kemampuan_penunjang);
                            ?>
                            <textarea name="jform[kemampuan_penunjang]" id="jform_kemampuan_penunjang" cols="0" rows="0" style="width:100%; height:100px;" class="mce_editable"><?php echo $value; ?></textarea>
                            <div id="editor-xtd-buttons"></div>
                            <div class="toggle-editor">
                                <div class="button2-left">
                                    <div class="blank">
                                        <a href="#" onclick="tinyMCE.execCommand('mceToggleEditor', true, 'jform_kemampuan_penunjang');return false;" title="Toggle editor">Toggle editor</a>
                                    </div>
                                </div>
                            </div>
						</li>
						<li>
							<label id="jform_bidang_minat-lbl" for="jform_bidang_minat" class="hasTip" title="Bidang Minat::Bidang minat">Bidang Minat</label>
							<div class="clr"></div>
							<?php
                                $value = set_value('jform[bidang_minat]', $data->bidang_minat);
                            ?>
                            <textarea name="jform[bidang_minat]" id="jform_bidang_minat" cols="0" rows="0" style="width:100%; height:100px;" class="mce_editable"><?php echo $value; ?></textarea>
                            <div id="editor-xtd-buttons"></div>
                            <div class="toggle-editor">
                                <div class="button2-left">
                                    <div class="blank">
                                        <a href="#" onclick="tinyMCE.execCommand('mceToggleEditor', true, 'jform_bidang_minat');return false;" title="Toggle editor">Toggle editor</a>
                                    </div>
                                </div>
                            </div>
						</li>
						<li>
							<label id="jform_lapangan_kerja-lbl" for="jform_lapangan_kerja" class="hasTip" title="Lapangan Kerja::Lapangan kerja.">Lapangan Kerja</label>
							<div class="clr"></div>
							<?php
                                $value = set_value('jform[lapangan_kerja]', $data->lapangan_kerja);
                            ?>
                            <textarea name="jform[lapangan_kerja]" id="jform_lapangan_kerja" cols="0" rows="0" style="width:100%; height:100px;" class="mce_editable"><?php echo $value; ?></textarea>
                            <div id="editor-xtd-buttons"></div>
                            <div class="toggle-editor">
                                <div class="button2-left">
                                    <div class="blank">
                                        <a href="#" onclick="tinyMCE.execCommand('mceToggleEditor', true, 'jform_lapangan_kerja');return false;" title="Toggle editor">Toggle editor</a>
                                    </div>
                                </div>
                            </div>
						</li>
						<li>
							<label id="jform_ptn_Sasaran-lbl" for="jform_ptn_Sasaran" class="hasTip" title="PT Sasaran::Perguruan tinggi sasaran.">PT Sasaran</label>
							<div class="clr"></div>
							<?php
                                $value = set_value('jform[ptn_Sasaran]', $data->ptn_Sasaran);
                            ?>
                            <textarea name="jform[ptn_Sasaran]" id="jform_ptn_Sasaran" cols="0" rows="0" style="width:100%; height:100px;" class="mce_editable"><?php echo $value; ?></textarea>
                            <div id="editor-xtd-buttons"></div>
                            <div class="toggle-editor">
                                <div class="button2-left">
                                    <div class="blank">
                                        <a href="#" onclick="tinyMCE.execCommand('mceToggleEditor', true, 'jform_ptn_Sasaran');return false;" title="Toggle editor">Toggle editor</a>
                                    </div>
                                </div>
                            </div>
						</li>
			...
			<div class="width-40 fltrt">
				<div id="jurusan-sliders" class="pane-sliders">
