	...
	Joomla.submitbutton = function(task) {
        ...
        switch (task) {
            case 'kesehatan.delete':
                document.adminForm.action = '<?php echo site_url('admin/kesehatan/delete'); ?>';
                break;
        }
		*/
		if (task != 'kesehatan.delete' || confirm('Are you sure you want to delete these menus? Confirming will delete the selected menu types, all their menu items and the associated menu modules.')) {
...
<div class="mc-wrapper">
	...
	<div id="content-box">
		...
		<div id="mc-component" class="clearfix">
			<form action="<?php echo site_url('admin/kesehatan'); ?>" method="post" name="adminForm" id="adminForm">
					...
					<div class="filter-select fltrt">
						<select name="filter_published" class="inputbox" onchange="this.form.submit()">
							<?php
								...
								$kesehatan_state = array_merge($first, $kesehatan_state);
								$kesehatan_state = array_merge($kesehatan_state, $last);
						...
						<select name="filter_kategori" class="inputbox" onchange="this.form.submit()">
							<?php
								...
								$kesehatan_kategori = array_merge($first, $kesehatan_kategori);
						...
						<select name="filter_status" class="inputbox" onchange="this.form.submit()">
							<?php
								$first = array(
									'' => '- Pilih Status Institusi Kesehatan -'
								);
								$kesehatan_status = array_merge($first, $kesehatan_status);
								foreach ($kesehatan_status AS $key => $value) {
									if (strval($key) === strval($filter_published))
										echo "<option value='$key' selected='selected'>$value&nbsp;&nbsp;</option>";
									else
										echo "<option value='$key'>$value&nbsp;&nbsp;</option>";
						...
						<select name="filter_wilayah" class="inputbox" onchange="this.form.submit()">
							<?php
								...
								$kesehatan_wilayah = array_merge($first, $kesehatan_wilayah);
				...
				<table class="adminlist">
					...
					<tbody>
						...
						<td class="nowrap">
							<a href="<?php echo site_url('admin/kesehatan/edit/'.$id); ?>"><?php echo $nama; ?></a>
						</td>
						<td class="center">
