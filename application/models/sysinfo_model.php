...
class Sysinfo_Model extends CI_Model {
    ...
    public function getInfo()
	{
		if (is_null($this->info))
		{
			...
			$this->info['dbversion']	= $this->db->Version();
			$this->info['dbcollation']	= $this->db->dbcollat;
			$this->info['phpversion']	= phpversion();
			$this->info['server']		= $sf;
			$this->info['sapi_name']	= php_sapi_name();
			$this->info['version']		= '1.0.0'; //$version->getLongVersion();
